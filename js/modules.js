(function() {
  ...
  var simpleTableModules = [
    ...
    {
      name: 'ipAddresses',
      template: '<table-data heading="IP Addresses" module-name="ip_addresses" info="IPs per interface"></table-data>'
    },
    {
      name: 'ramIntensiveProcesses',
      template: '<table-data heading="RAM Intensive Processes" module-name="ram_intensive_processes" info="Processes using the most RAM"></table-data>'
    },
    {
      name: 'cpuIntensiveProcesses',
      template: '<table-data heading="CPU Intensive Processes" module-name="cpu_intensive_processes" info="Processes using the most CPU"></table-data>'
    },
    {
      name: 'networkConnections',
      template: '<table-data heading="Network Connections" module-name="network_connections" info="netstat connections"></table-data>'
    },
    {
      name: 'serverAccounts',
    ...
    {
      name: 'arpCacheTable',
      template: '<table-data heading="ARP Cache Table" module-name="arp_cache" info="ARP cache info"></table-data>'
    },
    {
      name: 'commonApplications',
      template: '<table-data heading="Applications" module-name="common_applications" info="Installed packages"></table-data>'
    },
    {
      name: 'pingSpeeds',
    ...
    {
      name: 'internetSpeed',
      template: '<key-value-list heading="Internet Speed" module-name="internet_speed" info="Internet connection speed"></key-value-list>'
    },
    {
      name: 'memcached',
    ...
    {
      name: 'redis',
      template: '<key-value-list heading="Process Tree" module-name="redis" info="process tree"></key-value-list>'
    },
    {
      name: 'pm2',
      template: '<table-data heading="Process Status" module-name="pm2" info="prstat info"></table-data>'
    },    
    {
      name: 'memoryInfo',
    ...
    {
      name: 'cpuInfo',
      template: '<key-value-list heading="CPU Info" module-name="cpu_info" info="kstat cpu_info"></key-value-list>'
    },
    {
      name: 'ioStats',
    ...
    {
      name: 'zpoolList',
      template: '<table-data heading="ZPOOL List" module-name="zpool_list" info="ZFS pools"></table-data>'
    },
    {
      name: 'zfsList',
      template: '<table-data heading="ZFS List" module-name="zfs_list" info="ZFS datasets"></table-data>'
    },
    {
      name: 'ntpInfo',
      template: '<table-data heading="NTP Info" module-name="ntp_info" info="NTP info"></table-data>'
    },
    {
      name: 'suInfo',
      template: '<table-data heading="SU info" module-name="su_info" info="su info"></table-data>'
    }
  ];
